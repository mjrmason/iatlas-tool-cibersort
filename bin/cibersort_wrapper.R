...
result_object <- CIBERSORT("/home/aelamb/repos/irwg/iatlas-tool-cibersort/sample.references.matrix.txt",
                           "/home/aelamb/repos/irwg/iatlas-tool-cibersort/sample.mixtures.matrix.txt")
